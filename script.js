...
// console.log("Hello everybody".toLocaleUpperCase());
...
// let password = '';
// do{
//     password = prompt('введіть пароль більше 5 симболів');
...
// щось знайти
// const names = ['Alex', 'David', 'Nika', 'Bob', 'Yana', 'Artur'];
// console.log(names.includes('Artur'));
...
//splice
// const names = ['Bob', 'Mira', 'Alex', 'Nick', 'Nika'];
...
//додавання
// const names = ['Bob', 'Mira', 'Alex', 'Nick', 'Nika'];
// names.splice(0, 0, 'Діма');
// console.log(names);

//заміна
// const names = ['Bob', 'Mira', 'Alex', 'Nick', 'Nika'];
// names.splice(2, 1, 'Mariya');
// console.log(names);
